...
category: workflows/llm
ssot_path: .ai/skills/workflows/llm/llm_engineering
---

# llm_engineering (entry)

Canonical source: `.ai/skills/workflows/llm/llm_engineering/`

Open `.ai/skills/workflows/llm/llm_engineering/SKILL.md` and any supporting files referenced there (for example `reference.md`, `examples.md`, `scripts/`, `templates/`).
