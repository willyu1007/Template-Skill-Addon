...
2. Re-run verification: `node .../agent-builder.js verify --workdir <WORKDIR>`
{{else}}
### All Checks Passed

The agent is ready for:
1. Cleanup: `node .../agent-builder.js finish --workdir <WORKDIR> --apply`
...
*Generated by agent_builder Stage E verification*
