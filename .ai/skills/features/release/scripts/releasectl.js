...
function usage(exitCode = 0) {
  const msg = `
Usage:
  node .ai/skills/features/release/scripts/releasectl.js <command> [options]
...
Examples:
  ...
  node .ai/skills/features/release/scripts/releasectl.js changelog --from v1.1.0 --to HEAD
...
node .ai/skills/features/release/scripts/releasectl.js init --strategy semantic
node .ai/skills/features/release/scripts/releasectl.js status
node .ai/skills/features/release/scripts/releasectl.js prepare --version 1.0.0
node .ai/skills/features/release/scripts/releasectl.js changelog --from v0.9.0 --to HEAD
node .ai/skills/features/release/scripts/releasectl.js tag --version 1.0.0
\`\`\`
...
function cmdPrepare(repoRoot, version) {
  ...
  console.log(`  3. Tag when ready: node .ai/skills/features/release/scripts/releasectl.js tag --version ${v}`);
}
