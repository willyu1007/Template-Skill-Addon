...
function usage(exitCode = 0) {
  const msg = `
Usage:
  node .ai/skills/features/ci/scripts/cictl.js <command> [options]
...
Examples:
  node .ai/skills/features/ci/scripts/cictl.js init
  node .ai/skills/features/ci/scripts/cictl.js init --provider github
  node .ai/skills/features/ci/scripts/cictl.js init --provider gitlab
  node .ai/skills/features/ci/scripts/cictl.js add-delivery --provider github
  node .ai/skills/features/ci/scripts/cictl.js add-delivery --provider gitlab
  node .ai/skills/features/ci/scripts/cictl.js verify
  node .ai/skills/features/ci/scripts/cictl.js status
`;
