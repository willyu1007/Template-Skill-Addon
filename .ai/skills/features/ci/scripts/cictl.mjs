...
function usage(exitCode = 0) {
  const msg = `
Usage:
  node .ai/skills/features/ci/scripts/cictl.mjs <command> [options]
...
Examples:
  node .ai/skills/features/ci/scripts/cictl.mjs init
  node .ai/skills/features/ci/scripts/cictl.mjs init --provider github
  node .ai/skills/features/ci/scripts/cictl.mjs init --provider gitlab
  node .ai/skills/features/ci/scripts/cictl.mjs add-delivery --provider github
  node .ai/skills/features/ci/scripts/cictl.mjs add-delivery --provider gitlab
  node .ai/skills/features/ci/scripts/cictl.mjs verify
  node .ai/skills/features/ci/scripts/cictl.mjs status
`;
...
function cmdAddDelivery(repoRoot, provider, dryRun) {
  ...
  if (provider === 'github') {
    ...
    if (!fs.existsSync(srcPath)) {
      ...
      const begin = '# --- BEGIN DELIVERY (generated by cictl) ---';
      const end = '# --- END DELIVERY (generated by cictl) ---';
