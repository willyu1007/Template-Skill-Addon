...
function usage(exitCode = 0) {
  const msg = `
Usage:
  node .ai/skills/features/observability/scripts/obsctl.js <command> [options]
...
Examples:
  ...
  node .ai/skills/features/observability/scripts/obsctl.js add-metric --name http_requests_total --type counter --unit requests --labels method,path,status
...
\`\`\`bash
node .ai/skills/features/observability/scripts/obsctl.js init
node .ai/skills/features/observability/scripts/obsctl.js add-metric --name http_requests_total --type counter
node .ai/skills/features/observability/scripts/obsctl.js list-metrics
