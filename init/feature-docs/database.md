...
- Provides a human interface tool (query + change drafting): `node .ai/skills/features/database/db-human-interface/scripts/dbdocctl.cjs`
...
- `node .ai/skills/features/database/db-human-interface/scripts/dbdocctl.cjs` (human interface)
...
node .ai/skills/features/database/db-human-interface/scripts/dbdocctl.cjs query users

# Draft a change request (writes a modify doc with a dbops block)
node .ai/skills/features/database/db-human-interface/scripts/dbdocctl.cjs modify users

# Generate a plan (+ runbook when db.ssot=database)
node .ai/skills/features/database/db-human-interface/scripts/dbdocctl.cjs plan users
```
