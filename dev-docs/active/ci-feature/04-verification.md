...
- Init pipeline:
  - `node init/skills/initialize-project-from-requirements/scripts/init-pipeline.cjs validate --repo-root . --blueprint init/skills/initialize-project-from-requirements/templates/project-blueprint.example.json` ✅
...
- Delivery explicit enable (method A):
  ...
  - `node .ai/skills/features/ci/scripts/cictl.js add-delivery --provider gitlab --repo-root . --dry-run` ✅ (expects `.gitlab-ci.yml` to exist; run CI `init` first)
- Relocated controller entrypoints (help output):
  - `node .ai/skills/features/context-awareness/scripts/contextctl.js --help` ✅
  - `node .ai/skills/features/observability/scripts/obsctl.js --help` ✅
  - `node .ai/skills/features/packaging/scripts/packctl.js --help` ✅
  - `node .ai/skills/features/deployment/scripts/deployctl.js --help` ✅
  - `node .ai/skills/features/deployment/scripts/rollback.js --help` ✅
  - `node .ai/skills/features/release/scripts/releasectl.js --help` ✅
