...
category: scaffold/packs
ssot_path: .ai/skills/scaffold/packs/manage-skill-packs
---

# manage-skill-packs (entry)

Canonical source: `.ai/skills/scaffold/packs/manage-skill-packs/`

Open `.ai/skills/scaffold/packs/manage-skill-packs/SKILL.md` and any supporting files referenced there (for example `reference.md`, `examples.md`, `scripts/`, `templates/`).
